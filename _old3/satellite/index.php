    ...
    <main>
      ...
      <section class="sect_1">
        <div class="wrapper">
          <div class="container">
            <p class="c-anim-up">
            サウンドデザインフェスティバル in 浜松2021のサテライト会場として、浜松科学館と浜松市楽器博物館を位置づけて開催します！各館において、本イベント開催前からも音の可能性を感じられる催しや展示が企画されています。もちろんイベント開催両日にも面白い催しが行われます。イベント会場であるアクトシティ浜松展示イベントホールから徒歩数分で各館を訪問できますので、イベントと併せてお楽しみください！<br>3会場をめぐるデジタルスタンプラリーも開催予定。参加方法などの詳細は近日公開予定です。<br>
              ...
              <li class="c-anim-up">
                <div class="row">
                  <div class="text_wrap">
                    ...
                    <p>■ 時間：13:00〜、14:00〜、15:00〜（各回30分程度）</p>
                    <p>■ 会場：みらーらステージ</p>
                    <p>■ 料金：常設展入場料に含む</p>
                  </div>
                  <div class="img_wrap">
              ...
              <li class="c-anim-up">
                <div class="row">
                  <div class="text_wrap">
                    ...
                    <p>■ 内容：「音の正体が波である」ということをメインとしたサイエンスショーです。</p>
            ...
            <ul class="box_list">
              <li class="c-anim-up">
                <div class="row">
                  ...
                  <div class="img_wrap">
                    <figure><img src="/images/satellite/terumin.jpg" alt="竹内正実（テルミン）"></figure>
                  </div>
                </div>
                <div class="desc">
              ...
              <li class="c-anim-up">
                <div class="row">
                  ...
                  <div class="img_wrap">
                    <figure><img src="/images/satellite/maeda.jpg" alt="前田悠希"></figure>
                    <figure><img src="/images/satellite/suzuki.jpg" alt="鈴木雄也"></figure>
                  </div>
                </div>
              </li>
              <!-- <li class="c-anim-up">
              ...
              <li class="c-anim-up">
                <div class="row">
                  <div class="text_wrap">
                    ...
                    <p class="hosoku">※サウドデザインフェスティバル開催後も実施予定です。詳しい日程は<a href="https://www.gakkihaku.jp/" target="_blank">楽器博物館ホームページ</a>へ</p>
                  </div>
                  <div class="img_wrap">
                    <figure><img src="/images/satellite/terumin.jpg" alt="竹内正実（テルミン）"></figure>
                    <figure><img src="/images/satellite/hamaguchi.jpg" alt="濱口晶生"></figure>
                  </div>
                </div>
              </li>
              <li class="c-anim-up">
