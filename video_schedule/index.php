...
<head>
  ...
  <title>動画配信スケジュール | <?php echo SITE_NAME ?></title>
      ...
      <section class="sect_1">
        <div class="wrapper">
          <div class="container">
            ...
            <div class="row">
              <div class="col">
                <p>12<br class="sp">/<br class="sp">11 <br class="sp"><br class="pc">
                  （土）</p>
              </div>
              <div class="col">
                <ul>
            ...
            <div class="row">
              <div class="col">
                <p>12<br class="sp">/<br class="sp">12 <br class="sp"><br class="pc">
                （日）</p>
              </div>
              <div class="col">
                <ul>
                  ...
                  <!-- <li class="c-anim-up">
                    <div class="item_row">
                      <div class="itm">
                        ...
                        <h3>
                          <span>明和電機</span>
                          うなぎいも×明和電機 うなぎネットを作ろう</h3>
                        <p>
                        ■ 時間：11:45～13:15
                        </p>
                      </div>
                      <div class="itm">
                        <a href="/workshop/アクリルリコーダーワークショップ/" class="link_btn">詳しくはこちら</a>
                      </div>
                    </div>
                  </li> -->
                  <li class="c-anim-up">
