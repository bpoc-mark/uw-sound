          ...
          <div class="container">
            <div class="row">
              <picture class="c-anim-up">
                <source srcset="/images/global/sp/img_2.jpg" media="(max-width: 899px)" type="image/webp">
                <source srcset="/images/global/img_2.jpg" media="(min-width: 900px)">
                <img src="/images/global/sp/img_2.jpg" alt="使い方写真">
              </picture>
              <div class="col c-anim-up">
                <p>音を通して世界をつなぐことを目指して、サウンドデザイナーのスズキユウリ氏の協力のもと制作された「Global Sequencer」。スマートフォンやパソコンなどのインターネットを使える環境があれば、誰でも簡単に使うことができます。世界中から集まった音がランダムに組み合わされて新しい音となることで、コロナ禍でも世界とのつながりを感じられる作品です。</p>
                <dl>
                  <dt><span>■ ２つの使い方</span></dt>
                  <dd class="indent">・ 自分の音を投稿できる「投稿モード」</dd>
                  <dd class="indent">・ 投稿された音を組み合わせてその時だけの音を創る「シーケンサーモード」</dd>
                  <dd>11月11日（木）（予定）から音を投稿できます！ 身近な「音」を投稿してみてください。</dd>
                </dl>
                <dl>
                  <dt><span>■ 創った音をシェア</span></dt>
                  <dd>創った音は端末への保存やSNSでのシェアが可能。体験をみんなと共有することができます。</dd>
                </dl>
              </div>
            </div>
          </div>
              ...
              <div class="col">
                ...
                <picture >
								<!-- <source　srcset="/images/top/advan.webp" media="(min-width: 900px)" type="image/webp"> -->
									...
									<img src="/images/global/sp/img_1.jpg" alt="Yuri Suzuki" class="c-anim-up">
								</picture>
                <p class="c-anim-up">
