<div class="footer_inner container">
	<div class="top">
		<picture>
			...
			<source srcset="/images/common/footer_img_1_sp.svg" media="(max-width: 899px)" type="image/webp">
			<source srcset="/images/common/footer_img_1.svg" media="(min-width: 900px)">
			<img src="/images/common/footer_img_1_sp.png" alt="">
		</picture>
		<div class="row">
			<div class="col">
				<h4>【 新型コロナウイルス感染防止対策へのご協力のお願い 】</h4>
				<p>
					マスクの常時着用、咳エチケット、入場時の手指消毒や検温へのご協力をお願いします。<br>
					万が一、感染者が発生した場合、保健所等の公的機関へお客様の氏名と連絡先を提供する場合があります。<br>
					混雑を緩和するため他のお客様との間隔を、十分（最低１ｍ）取るようお願いいたします。受付、インフォメーション等の床に立ち位置を明示しますので、間隔を開けるようお願いいたします。<br>
			...
			<div class="col">
				...
				<nav>
					<ul>
						...
						<li><a href="https://www.youtube.com/channel/UCC3ltT2lGbSh54CF8rqJrbw" target="_blank">SDF2021 <br class="sp">YouTubeチャンネル</a></li>
					</ul>
					<ul>
				...
				<p>お問い合わせ：（公財）浜松市文化振興財団　<br class="sp">Tel.<a class="tel" href="tel:053-451-1151">053-451-1151</a> ／ Mail. <a href="mailto:sdf2021@hcf.or.jp">sdf2021@hcf.or.jp</a></p>
			</div>
			<div class="col">
				<h5>【 主催 】</h5>
				<p>
